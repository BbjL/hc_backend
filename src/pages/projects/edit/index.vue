      ...
      <el-row>
        <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
          <el-form-item label-width="100px" label="项目标题：" prop="proName">
            <el-input style="width: 300px" v-model="ruleForm.proName " placeholder="输入标题" class="manage_input"></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
          <el-form-item  label-width="100px" label="上传人员："  prop="createBy">
            <el-input style="width: 300px" v-model="ruleForm.createBy " placeholder="输入上传人员" class="manage_input"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
